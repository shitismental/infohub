import BgCardImg from "../assets/imgs/testimg.png";
import BgCardImg2 from "../assets/imgs/testimg2.png";
import HeroCardImg from "../assets/imgs/card_img.png";
import HeroCardImg2 from "../assets/imgs/card_img_2.png";
...
export const homeDisplayCourses = [
  {
    id: 11,
    mainCourseInfo: {
      name: "Арбітраж",
      description: "Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж Арбітраж",
      price: 1600,
      stages: [
        {
          id: 1,
